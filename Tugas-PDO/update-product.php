    ...
    <form action="" method="post">
        <table class="insert" cellspacing="1" cellpadding="4">
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" name="productName" id="productName" value="<?php echo $data["productName"]; ?>">
                </td>
            </tr>
            <tr>
                <td><label for="productLine">Product Line </label></td>
                <td>:</td>
                <td><select class="formsizee" id="productLine" name="productLine"
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" name="productScale" id="productScale"
                        value="<?php echo $data["productScale"]; ?>"></td>
            </tr>
            <tr>
                <td><label for="productVendor">Product Vendor </label></td>
                <td>:</td>
                <td><input type="text" name="productVendor" id="productVendor"
                        value="<?php echo $data["productVendor"]; ?>"></td>
            </tr>
            <tr>
                <td><label for="productDescription">Product Description </label></td>
                <td>:</td>
                <td><textarea name="productDescription" id="productDescription" cols="52"
                        rows="10"><?php echo $data["productDescription"]; ?></textarea></td>
            </tr>
            <tr>
                <td><label for="quantityInStock">Quantity In Stock </label></td>
                <td>:</td>
                <td><input type="text" name="quantityInStock" id="quantityInStock"
                        value="<?php echo $data["quantityInStock"]; ?>"></td>
            </tr>
            <tr>
                <td><label for="buyPrice">Buy Price </label></td>
                <td>:</td>
                <td><input type="text" name="buyPrice" id="buyPrice" value="<?php echo $data["buyPrice"]; ?>"></td>
            </tr>
            <tr>
                <td><label for="MSRP">MSRP </label></td>
                <td>:</td>
                <td><input type="text" name="MSRP" id="MSRP" value="<?php echo $data["MSRP"]; ?>"></td>
            </tr>
            <tr>

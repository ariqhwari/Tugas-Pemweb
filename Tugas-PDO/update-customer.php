    ...
    <form action="" method="post">
        <table class="insert" cellspacing="1" cellpadding="4">
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" name="state" id="state" value="<?php echo $data["state"]; ?>"></td>
            </tr>
            <tr>
                <td><label for="postalCode">Postal Code </label></td>
                <td>:</td>
                <td><input type="text" name="postalCode" id="postalCode" value="<?php echo $data["postalCode"]; ?>">
                </td>
            </tr>
            <tr>
                <td><label for="country">Country </label></td>
                <td>:</td>
                <td><input type="text" name="country" id="country" value="<?php echo $data["country"]; ?>"></td>
            </tr>
            <tr>
                <td><label for="salesRepEmployeeNumber">Sales Rep Employee Number </label></td>
                <td>:</td>
                <td><select class="formsize" id="salesRepEmployeeNumber" name="salesRepEmployeeNumber"
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" name="creditLimit" id="creditLimit" value="<?php echo $data["creditLimit"]; ?>">
                </td>
            </tr>
            <tr>
